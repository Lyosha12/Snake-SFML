...
class Bonus {
     ...
     * По сути, команда с отложенным и неоднократным выполнением.
     *
  ...
  public:
     ...
     *
     * Когда из потомка Bonus будет возвращена функция LazyCreator,
     ...
     * потомка Bonus о том, что заполнитель, хранящий LazyCreator, уничтожен,
     * из-за чего бонус невозможно взять и он считается
